...
### ✨ 核心功能
- **雙語支持**：提供繁體中文與英文版本，擴大影響力。
- **長輩友善 UI**：超大字體、高對比色塊，降低數位門檻。
- **科學實證**：所有答案均參考衛福部、台灣事實查核中心等權威機構。
...
### ✨ Key Features
- **Bilingual Support**: Accessible in both Traditional Chinese and English.
- **Inclusive Design**: Large fonts and high-contrast buttons optimized for senior users.
- **Fact-Based Content**: All quiz data is cross-referenced with official health organizations and fact-checking centers.
